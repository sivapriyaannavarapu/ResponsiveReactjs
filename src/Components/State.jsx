...
const State = ({ states }) => {
  ...
  // Combined scroll logic for footer visibility and header shrinking (mobile only)
  useEffect(() => {
    const tableWrapper = tableWrapperRef.current;
    

    const handleScroll = () => {
      if (!tableWrapper || !headerRef.current) return;
      ...
      // Header scroll logic (only for mobile < 768px)
      const isMobile = window.innerWidth < 768;
      if (isMobile) {
        if (scrollTop > 30 && scrollTop > lastScrollTop.current) {
          headerRef.current.classList.add('scrolled-up');
          tableWrapper.classList.add('scrolled-up');
        } else {
          headerRef.current.classList.remove('scrolled-up');
          tableWrapper.classList.remove('scrolled-up');
        }
    ...
    if (tableWrapper) {
      // Ensure header is not scrolled-up initially
    ...
    const handleResize = () => {
      if (window.innerWidth >= 768 && headerRef.current && tableWrapper) {
        headerRef.current.classList.remove('scrolled-up');
        tableWrapper.classList.remove('scrolled-up');
      }
    };
  ...
  return (
    <div className="state-page">
      <div className="state-header" ref={headerRef}>
        <div className="breadcrumb-wrapper">
          ...
          >
            <path
              d="M1.12488 8.375L4.87488 4.625L1.12488 0.875"
              stroke="#6E7C87"
              strokeWidth="1.5"
              strokeLinecap="round"
        ...
        <div className="state-buttons">
          ...
          <button
            ...
            className={`btn add ${isButtonClicked ? 'add-clicked' : ''}`}
          >
      ...
      <div className="state-table-wrapper" ref={tableWrapperRef}>
        {isAddingField ? (
                  ...
                  <td className="action-buttons">
                    ...
                    <button className="icon-button">
                      ...
                      >
                        ...
                        <path
                          d="M18.5 7H13.8333C13.4797 7 13.1406 7.14048 12.8905 7.39052C12.6405 7.64057 12.5 7.97971 12.5 8.33333V17.6667C12.5 18.0203 12.6405 18.3594 12.8905 18.6095C13.1406 18.8595 13.4797 19 13.8333 19H23.1667C23.5203 19 23.8594 18.8595 24.1095 18.6095C24.3595 18.3594 24.5 18.0203 24.5 17.6667V13"
                          stroke="#20179D"
                          strokeWidth="1.33333"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                        />
                        <path
                          d="M22.7501 6.75015C23.0154 6.48493 23.3751 6.33594 23.7501 6.33594C24.1252 6.33594 24.4849 6.48493 24.7501 6.75015C25.0154 7.01537 25.1644 7.37508 25.1644 7.75015C25.1644 8.12522 25.0154 8.48493 24.7501 8.75015L18.7415 14.7595C18.5832 14.9176 18.3876 15.0334 18.1728 15.0962L16.2575 15.6562C16.2001 15.6729 16.1393 15.6739 16.0814 15.6591C16.0235 15.6442 15.9707 15.6141 15.9284 15.5719C15.8862 15.5296 15.8561 15.4768 15.8412 brilliantly15.4189C15.8264 15.361 15.8274 15.3002 15.8441 15.2428L16.4041 13.3275C16.4672 13.1129 16.5832 12.9175 16.7415 12.7595L22.7501 6.75015Z"
                          stroke="#20179D"
                          strokeWidth="1.33333"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                    ...
                    <button className="icon-button">
                      ...
                      >
                        ...
                        />
                        <path
                          d="M19 13C19 12.4696 18.7893 11.9609 18.4142 11.5858C18.0391 11.2107 17.5304 11 17 11C16.4696 11 15.9609 11.2107 15.5858 11.5858C15.2107 11.9609 15 12.4696 15 13C15 13.5304 15.2107 14.0391 15.5858 14.4142C15.9609 14.7893 16.4696 15 17 15C17.5304 15 18.0391 14.7893 18.4142 14.4142C18.7893 14.0391 19 13.5304 19 13Z"
                          stroke="#7B7B7B"
                          strokeWidth="1.33333"
                          strokeLinecap="round"
                          strokeLinejoin="round"
        ...
        <div className="pagination">
          <div className="pro-tip-container">
            <div className="pro-tip-box">
              <img src={bulb} alt="Light Bulb" className="bulb-icon" />
